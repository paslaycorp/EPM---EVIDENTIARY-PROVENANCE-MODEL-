"""Epistemic source typing for EPM."""
...
def validate_source_record(record: EpistemicSourceRecord) -> SourceTypingResult:
    ...
    if (
        ...
        return SourceTypingResult(
            ...
            "Observation requires an external origin outside the current computation boundary.",
        )
    if (
        ...
        return SourceTypingResult(
            ...
            "External attestation requires an external origin.",
        )
    return SourceTypingResult(
        True,
        "SOURCE_TYPE_VALID",
...
def observation_reclassification_allowed(
    ...
    *,
    ...
    """Reject relabeling internal outputs as observations."""
    ...
    return SourceTypingResult(
        ...
        "New observation may support a new state, but it does not change the provenance type of the pre-existing source.",
    )
